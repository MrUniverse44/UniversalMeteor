package me.blueslime.meteor.platforms.paper.tasks;
...
import me.blueslime.meteor.platforms.paper.tasks.handle.PaperTaskHandle;
...
public class PaperPlatformTasks implements PlatformTasks {
    ...
    public PaperPlatformTasks(JavaPlugin plugin) {
        this.plugin = plugin;
        if (plugin != null) {
    ...
    public TaskHandle schedule(Runnable task, TaskOptions options) {
        ...
        PaperTaskHandle handle = new PaperTaskHandle(id, bt, options);
